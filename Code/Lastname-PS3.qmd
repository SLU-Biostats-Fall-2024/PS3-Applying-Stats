...
The variation explained by sex is 111.063, while the variation explained by age and the interaction variable are both \<3. The sex variable has a p value of \<2e-16, suggesting we reject our hypothesis.
...
I reject the null hypothesis that the number of ticks found on the bats is not associated with either their sex or age. Further analysis suggests that the number of ticks found on the bats is associated with their sex (F=116.6779, df=1, p\<2e-16). Meanwhile, there is no significant impact of age nor a sex/age interaction on tick number in this model (F=2.7431,df=1,p=0.1003), (F=2.4668,df=1,p=0.1189)
